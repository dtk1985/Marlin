...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH          0.8  // (mm) Initial retract. //was 2
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    85  // (mm) Slow length, to allow time to insert material.
